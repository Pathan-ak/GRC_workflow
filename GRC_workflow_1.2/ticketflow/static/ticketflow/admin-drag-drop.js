        ...
        dataRows.forEach((row, index) => {
            ...
            if (cells.length > firstDataColumnIndex) {
                ...
                if (!firstDataCell.querySelector(dragHandleClass)) {
                    ...
                    dragHandle.style.cssText = 'cursor: grab; font-size: 11px; line-height: 1; color: #417690; padding: 2px 4px; display: inline-flex; align-items: center; justify-content: center; vertical-align: middle; flex-shrink: 0;';
